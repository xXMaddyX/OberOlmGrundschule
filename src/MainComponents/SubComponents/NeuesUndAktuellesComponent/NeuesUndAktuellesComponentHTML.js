...
<div>
    ...
    <section name="termin">
        <div class="termine wrapper">
            <h1>Termine</h1>
            <div class="termin-nav-leiste">
                <button class="termin-buttons" id="termin-btn-left">&#10096;</button>
                <p id="termin-page-display">0</p>
                <button class="termin-buttons" id="termin-btn-right">&#10097;</button>
            </div>
            <div id="termin-displayer"></div>
        </div>
    </section>
    <div class="spacer"></div>
